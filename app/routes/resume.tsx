        ...
        <main className="!pt-0">
            ...
            <div className="flex flex-row w-full max-lg:flex-col-reverse">
                <section className="feedback-section bg-[url('/images/bg-small.svg')] bg-cover h-[100vh] sticky top-0 flex items-center justify-center">
                    {                                                                                             // extra flex added by me suggetsed by claude
                        imageUrl && resumeUrl && (
                            <div className="animate-in gradient-in fade-in duration-100 gradient-border max-sm:m-0 w-full max-w-sm lg:max-w-md h-auto">
                ...
                <section className="feedback-section">  
                    ...
                    {feedback? (
                        <div className="flex flex-col gap-8 animate-in fade-n duration-1000">
